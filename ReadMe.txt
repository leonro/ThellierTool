========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Thellier
========================================================================


Diese Thellier-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Thellier-Anwendung bilden.
...
res\Thellier.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Thellier.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in Thellier.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ThellierDoc.h, ThellierDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CThellierDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CThellierDoc::Serialize).

ThellierView.h, ThellierView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CThellierView.
    	CThellierView-Objekte werden verwendet, um CThellierDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Thellier.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
