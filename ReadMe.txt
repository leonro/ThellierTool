...
Diese ThellierTool-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ThellierTool.rc, um Schaltflächen für die
